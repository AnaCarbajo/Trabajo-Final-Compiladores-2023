...
public class Scanner {
	...
	static {
		...
		for (int i = 48; i <= 57; ++i) start.set(i, 23);
		start.set(58, 1); 
		start.set(44, 2); 
		start.set(123, 3); 
		start.set(125, 4); 
		...
		literals.put("true", new Integer(12));
		literals.put("false", new Integer(13));
		literals.put("null", new Integer(14));
		...
		loop: for (;;) {
			switch (state) {
				...
				case 7:
					...
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); state = 7; break;}
					else {t.kind = 7; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 8:
					if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= '!' || ch >= '#' && ch <= '[' || ch >= ']' && ch <= 65535) {AddCh(); state = 8; break;}
					else if (ch == '"') {AddCh(); state = 13; break;}
					else if (ch == 92) {AddCh(); state = 26; break;}
					else {state = 0; break;}
				case 9:
				...
				case 16:
					...
					if (ch >= '0' && ch <= '9') {AddCh(); state = 16; break;}
					else if (ch == 'E' || ch == 'e') {AddCh(); state = 17; break;}
					else {t.kind = 11; break loop;}
				case 17:
					if (ch >= '0' && ch <= '9') {AddCh(); state = 19; break;}
					else if (ch == '+' || ch == '-') {AddCh(); state = 18; break;}
					else {state = 0; break;}
				case 18:
					if (ch >= '0' && ch <= '9') {AddCh(); state = 19; break;}
					else {state = 0; break;}
				...
				case 23:
					...
					if (ch >= '0' && ch <= '9') {AddCh(); state = 23; break;}
					else if (ch == '.') {AddCh(); state = 15; break;}
					else if (ch == 'E' || ch == 'e') {AddCh(); state = 20; break;}
					else {t.kind = 10; break loop;}
				case 24:
					if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= '!' || ch >= '#' && ch <= '[' || ch >= ']' && ch <= 65535) {AddCh(); state = 24; break;}
					else if (ch == 10 || ch == 13) {AddCh(); state = 14; break;}
					else if (ch == '"') {AddCh(); state = 13; break;}
					else if (ch == 92) {AddCh(); state = 27; break;}
					else {state = 0; break;}
				case 25:
					if (ch >= '0' && ch <= '9') {AddCh(); state = 23; break;}
					else {state = 0; break;}
				case 26:
					if (ch == '"' || ch == '/' || ch == 92 || ch == 'b' || ch == 'f' || ch == 'n' || ch == 'r' || ch == 't') {AddCh(); state = 8; break;}
					else if (ch == 'u') {AddCh(); state = 9; break;}
					else {state = 0; break;}
				case 27:
					if (ch == '"' || ch == '/' || ch == 92 || ch == 'b' || ch == 'f' || ch == 'n' || ch == 'r' || ch == 't') {AddCh(); state = 24; break;}
					else if (ch == 'u') {AddCh(); state = 9; break;}
					else {state = 0; break;}
